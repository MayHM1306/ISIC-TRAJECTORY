...
<html>
    <head>
        ...
        <!--<link rel="stylesheet" href="../utils/css/styles_especialidadDivision.css">-->  
    ...
    <body>
        ...
        <div class="barraRegistros">
            <button  class="btnR" onclick="window.location.href = 'Registros_Especialidades.php'">
                <a href="#">
        ...
        <div class="contRegJefes">
            <div class="fondoJefes">
                <label class="jdd">ESPECIALIDADES DE DIVISIÓN</label>
            </div>
            <div class="titRJ">
                Información
