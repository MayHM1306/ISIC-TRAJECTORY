...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Jefes de División</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="../utils/css/styles_Encabezado.css">  
        <!--<link rel="stylesheet" href="../utils/css/styles_jefeDivision.css">-->  
    ...
    <body>
        ...
        <div class="barraRegistros">
            <button  class="btnR" onclick="window.location.href = 'Registros_Jefes.php'">
                <a href="#">
